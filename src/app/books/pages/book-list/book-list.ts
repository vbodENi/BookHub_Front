...
export class BookList implements OnInit {
  ...
  onlyAvailable = signal(false); // case dispo/tout
    ...
    filteredBooks = computed(() => {
      ...
      const q = normalize(this.search()); // récupère ce que l'utilisateur a tapé en minuscules
  ...
  ngOnInit(): void {
    ...
    this.bookService.getCategories().subscribe({next: data => this.categories.set(data), error: () => {}});
  }
}
